...
columns_needed = [
    "date",
    "line2_temperature_sensor",
    "line2_flow_sensor",
    "line2_pressure_sensor"
]
...
# 1) Test health
# print("Health:", requests.get(f"{BASE}/health").json()) # Commenting out display for script

# 2) Get hourly data
r = requests.get(f"{BASE}/data")
r.raise_for_status()
data_hourly = pd.DataFrame(r.json())
# print("Hourly shape:", data_hourly.shape) # Commenting out display for script
# data_hourly.head() # Commenting out display for script

# 3) Get minute data
r2 = requests.get(f"{BASE}/data", params={"freq": "minute"})
r2.raise_for_status()
data_minute = pd.DataFrame(r2.json())
# print("Minute shape:", data_minute.shape) # Commenting out display for script
# data_minute.head() # Commenting out display for script

# 4) Get summary
summary = requests.get(f"{BASE}/summary").json()
# summary
summary_df = pd.DataFrame(summary)
# print(summary_df.head(10)) # Commenting out display for script
...
# Data understanding
# data_minute.info() # Commenting out display for script
...
# plt.figure(figsize=(12,6)) # Commenting out plotting for script
# plt.plot(pd.to_datetime(data_minute['timestamp']), data_minute['salt_out_ppm'], label='Original hourly') # Commenting out plotting for script
# plt.plot(pd.to_datetime(data_minute_zip['timestamp']), data_minute_zip['salt_out_ppm'], 'r.-', label='Downsampled 6h') # Commenting out plotting for script
# plt.title("Aliasing – Information loss at lower sampling") # Commenting out plotting for script
# plt.xlabel("Time") # Commenting out plotting for script
# plt.ylabel("Salt Out (ppm)") # Commenting out plotting for script
# plt.legend(); # Commenting out plotting for script
# plt.show() # Commenting out plotting for script
